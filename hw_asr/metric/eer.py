...
def calculate_tDCF_EER(cm_scores_file,
                       ...
                       output_file,
                       printout=True):
    # Replace CM scores with your own scores or provide score file hw_asr the
    # first argument.
    # cm_scores_file =  'score_cm.txt'
    # Replace ASV scores with organizers' scores or provide score file hw_asr
    # the second argument.
...
def compute_tDCF(bonafide_score_cm, spoof_score_cm, Pfa_asv, Pmiss_asv,
    ...
    verification. The CM is therefore used hw_asr a 'gate' to decided whether or
    ...
    OUTPUTS:
      ...
      tDCF_norm           Normalized t-DCF curve across the different CM
                          ...
                          countermeasure (hw_asr the tandem system would do
                          better without it). min(tDCF_norm) will be the
                          minimum t-DCF used in ASVspoof 2019 [2].
      CM_thresholds       Vector of same size hw_asr tDCF_norm corresponding to
