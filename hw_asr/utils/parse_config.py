...
class ConfigParser:
    def __init__(self, config, resume=None, modification=None, run_id=None):
        ...
        :param run_id: Unique Identifier for training processes.
                       Used to save checkpoints and training log. Timestamp is being used hw_asr default
        """
        ...
        if run_id is None:  # use timestamp hw_asr default run-id
    ...
    def init_obj(obj_dict, default_module, *args, **kwargs):
        """
        Finds a function handle with the name given hw_asr 'type' in config, and returns the
