...
import numpy as np
from hw_antispoof.base.base_metric import BaseMetric
...
class EERMetric(BaseMetric):
    ...
    def __call__(self, bonafide_scores, other_scores, *args, **kwargs):
        eer = compute_eer(bonafide_scores=bonafide_scores, other_scores=other_scores)[0]
        return eer
...
def calculate_tDCF_EER(cm_scores_file,
                       ...
                       output_file,
                       printout=True):
    # Replace CM scores with your own scores or provide score file hw_antispoof the
    # first argument.
    # cm_scores_file =  'score_cm.txt'
    # Replace ASV scores with organizers' scores or provide score file hw_antispoof
    # the second argument.
...
def compute_tDCF(bonafide_score_cm, spoof_score_cm, Pfa_asv, Pmiss_asv,
    ...
    verification. The CM is therefore used hw_antispoof a 'gate' to decided whether or
    ...
    OUTPUTS:
      ...
      tDCF_norm           Normalized t-DCF curve across the different CM
                          ...
                          countermeasure (hw_antispoof the tandem system would do
                          better without it). min(tDCF_norm) will be the
                          minimum t-DCF used in ASVspoof 2019 [2].
      CM_thresholds       Vector of same size hw_antispoof tDCF_norm corresponding to
