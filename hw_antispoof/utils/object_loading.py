...
import hw_antispoof.augmentations
import hw_antispoof.datasets
from hw_antispoof import batch_sampler as batch_sampler_module
from hw_antispoof.base.base_text_encoder import BaseTextEncoder
from hw_antispoof.collate_fn.collate import collate_fn
...
def get_dataloaders(configs: ConfigParser):
    ...
    for split, params in configs["data"].items():
        ...
        if split == 'train':
            wave_augs, spec_augs = hw_antispoof.augmentations.from_configs(configs)
            drop_last = True
        else:
        ...
        for ds in params["datasets"]:
            datasets.append(configs.init_obj(
                ds, hw_antispoof.datasets, config_parser=configs,
