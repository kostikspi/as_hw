...
from hw_antispoof.base import BaseModel

from hw_antispoof.model.SincConv import SincConv_fast
from hw_antispoof.model.ResBlock import ResBlock


class RawNet(BaseModel):
    def __init__(self, do_abs, sinc_hz=0, sinc_band=0, gru_layers=3, do_bn=True, grad_sinc=False):
        super().__init__()
        self.do_abs = do_abs
        # HINT #5
